...
<div class="container-fluid">
    <h2 class="mb-4">Tambah Data Role</h2>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data Role</h6>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('admin.role.store') }}" method="POST" class="form-container">
                @csrf
