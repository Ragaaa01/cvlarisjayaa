...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <div>
                <a href="{{ route('admin.jenis_tabung.create') }}" class="btn btn-custom">
                    <i class="fas fa-plus mr-1"></i> Tambah Data
                </a>
            </div>
            <div>
                <a href="{{ route('admin.jenis_tabung.export.excel') }}" class="btn btn-success">
                    <i class="fas fa-file-excel mr-1"></i> Export Excel
                </a>
                <a href="{{ route('admin.jenis_tabung.export.pdf') }}" class="btn btn-danger">
...
<script>
    $(document).ready(function() {
        var table = $('#dataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route("admin.jenis_tabung.index") }}'
            },
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                { data: 'nama_jenis', name: 'nama_jenis' },
                { data: 'harga_pinjam', name: 'harga_pinjam' },
                { data: 'harga_isi_ulang', name: 'harga_isi_ulang' },
                { data: 'nilai_deposit', name: 'nilai_deposit' },
