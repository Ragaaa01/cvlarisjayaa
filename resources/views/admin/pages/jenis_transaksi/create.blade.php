...
<div class="card shadow mt-4 mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form Tambah Jenis Transaksi</h6>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <div class="form-container">
            <form action="{{ route('admin.jenis_transaksi.store') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="jenis_transaksi">Jenis Transaksi</label>
                    <input type="text" name="jenis_transaksi" id="jenis_transaksi" class="form-control" value="{{ old('jenis_transaksi') }}" required>
                </div>
                <div class="form-group">
