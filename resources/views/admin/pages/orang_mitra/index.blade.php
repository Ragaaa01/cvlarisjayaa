...
@section('title', 'Data Orang Mitra')
...
@section('content')
<h2>Data Orang Mitra</h2>
<div class="card shadow mt-4 mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <div>
            <a href="{{ route('admin.orang_mitra.create') }}" class="btn btn-custom">
                <i class="fas fa-plus mr-1"></i> Tambah Data
            </a>
        </div>
        <div>
            <a href="{{ route('admin.orang_mitra.export.excel') }}" class="btn btn-success">
                <i class="fas fa-file-excel mr-1"></i> Export Excel
            </a>
            <a href="{{ route('admin.orang_mitra.export.pdf') }}" class="btn btn-danger">
...
<script>
    $(document).ready(function() {
        var table = $('#dataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route("admin.orang_mitra.index") }}'
            },
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                { data: 'nama_orang', name: 'orang.nama_lengkap' },
                { data: 'nama_mitra', name: 'mitra.nama_mitra' },
                { data: 'status_valid', name: 'status_valid' },
