...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <div>
                <a href="{{ route('admin.akun.create') }}" class="btn btn-custom">
                    <i class="fas fa-plus mr-1"></i> Tambah Data
                </a>
            </div>
            <div>
                <a href="{{ route('admin.akun.export.excel', ['id_role' => request('id_role')]) }}" class="btn btn-success">
                    <i class="fas fa-file-excel mr-1"></i> Export Excel
                </a>
                <a href="{{ route('admin.akun.export.pdf', ['id_role' => request('id_role')]) }}" class="btn btn-danger">
        ...
        <div class="card-body">
            ...
            <div class="filter-container">
                ...
                <select class="form-control d-inline-block" id="filter_role">
                    <option value="" {{ empty(request('id_role')) ? 'selected' : '' }}>Semua Role</option>
                    @foreach ($roles as $role)
                        <option value="{{ $role->id_role }}" {{ request('id_role') == $role->id_role ? 'selected' : '' }}>{{ $role->nama_role }}</option>
                    @endforeach
                </select>
            </div>
