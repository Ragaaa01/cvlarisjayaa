...
<div class="container-fluid">
    <h2 class="mb-4">Tambah Data Akun</h2>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('admin.akun.store') }}" method="POST" class="form-container">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="id_orang" id="id_orang" class="form-control select2" required>
                        ...
                        @foreach ($orangs as $orang)
                            <option value="{{ $orang->id_orang }}" {{ old('id_orang') == $orang->id_orang ? 'selected' : '' }}>{{ $orang->nama_lengkap }}</option>
                        @endforeach
                    </select>
                </div>
...
<script>
    $(document).ready(function() {
        // Inisialisasi Select2 untuk id_orang
        $('#id_orang').select2({
