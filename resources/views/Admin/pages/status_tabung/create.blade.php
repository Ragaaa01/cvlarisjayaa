...
<div class="card shadow mt-4 mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Form Tambah Status Tabung</h6>
    </div>
    <div class="card-body form-container">
        ...
        <form action="{{ route('admin.status_tabung.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="status_tabung" name="status_tabung" value="{{ old('status_tabung') }}" required>
            </div>
