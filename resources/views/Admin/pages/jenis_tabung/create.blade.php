...
<div class="card shadow mt-4 mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form Tambah Jenis Tabung</h6>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form action="{{ route('admin.jenis_tabung.store') }}" method="POST">
            ...
            <div class="form-group input-rupiah">
                ...
                <input type="text" name="harga_pinjam" id="harga_pinjam" class="form-control rupiah" value="{{ old('harga_pinjam', '0') }}" required>
                <input type="hidden" name="harga_pinjam_value" id="harga_pinjam_value">
            </div>
            <div class="form-group input-rupiah">
                <label for="harga_isi_ulang">Harga Isi Ulang (Rp)</label>
                <span class="rupiah-prefix">Rp</span>
                <input type="text" name="harga_isi_ulang" id="harga_isi_ulang" class="form-control rupiah" value="{{ old('harga_isi_ulang', '0') }}" required>
                <input type="hidden" name="harga_isi_ulang_value" id="harga_isi_ulang_value">
            </div>
            <div class="form-group input-rupiah">
                <label for="nilai_deposit">Nilai Deposit (Rp)</label>
                <span class="rupiah-prefix">Rp</span>
                <input type="text" name="nilai_deposit" id="nilai_deposit" class="form-control rupiah" value="{{ old('nilai_deposit', '0') }}" required>
                <input type="hidden" name="nilai_deposit_value" id="nilai_deposit_value">
            </div>
            <div class="form-group">
